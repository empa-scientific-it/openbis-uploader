...
class OpenbisDatasetParser(ABC):
    ...
    Because this class is derived from :obj:`pydantic.BaseModel`
    """

    # @abstractmethod
    # def register_masterdata():
    #     """
    #     If needed, register additional masterdata for openbis
    #     """
    #     pass
    ...
    def process(self, ob: Openbis, transaction: Transaction, dataset: DataSet, *args, **kwargs) -> Transaction:
        ...
        Additional parameters can be defined, to provide ty
        """
        pass
